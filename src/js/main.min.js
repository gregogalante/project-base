    ...
    M.cancelScroll = function (e) {
      ...
      if (u || g) {
        ...
        var S,
            O,
            A,
            C = u ? n : l(g, b, parseInt("function" == typeof i.offset ? i.offset(n, r) : i.offset, 10), i.clip),
            w = C - v,
            L = s(),
            H = 0,
            q = f(w, i),
...
var ServicesCarousel = function () {
  ...
  var initializePages = function initializePages() {
    var pages = document.querySelectorAll('.js-services-carousel-page');
    pages.forEach(function (page) {
      page.addEventListener('click', function () {
        var index = Array.prototype.indexOf.call(page.parentElement.children, page);
        flickity.select(index);
        pages.forEach(function (page) {
          return page.classList.remove('is-selected');
        });
        page.classList.add('is-selected');
      });
    });
    flickity.on('change', function (slide) {
      pages.forEach(function (page) {
        return page.classList.remove('is-selected');
      });
  ...
  var initializeNext = function initializeNext() {
    var nexts = document.querySelectorAll('.js-services-carousel-next');
